...
Mobile.verifyElementExist(findTestObject('Home Module/Positive/android.widget.ImageView'), 0)

Mobile.verifyElementExist(findTestObject('Home Module/Positive/android.widget.ImageView (1)'), 0)

Mobile.verifyElementExist(findTestObject('Home Module/Positive/android.widget.ImageView (2)'), 0)
...
Mobile.tap(findTestObject('Home Module/Positive/android.widget.ImageView (3)'), 0)
