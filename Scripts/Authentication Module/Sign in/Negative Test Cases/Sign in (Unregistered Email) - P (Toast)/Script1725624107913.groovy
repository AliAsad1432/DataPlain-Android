...
Mobile.tap(findTestObject('Object Repository/Auth/Sign in/android.widget.Button - ALLOW'), 0)
...
Mobile.pressBack()
Mobile.setText(findTestObject('Object Repository/Auth/Sign in/android.widget.EditText (1)'), 'Sen@12341', 0)
Mobile.pressBack()
