...
Mobile.setText(findTestObject('Object Repository/Sign Up/android.widget.EditText (4)'), 'Pakistan@1', 0)
...
Mobile.verifyElementExist(findTestObject('Sign Up/android.view.View'), 0)
