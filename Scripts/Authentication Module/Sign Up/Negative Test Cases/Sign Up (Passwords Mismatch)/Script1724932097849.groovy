...
Mobile.setText(findTestObject('Object Repository/Sign Up/android.widget.EditText (4)'), 'Pakistan@12', 0)

Mobile.pressBack()

Mobile.tap(findTestObject('Object Repository/Sign Up/android.widget.Button (1)'), 0)

Mobile.verifyElementExist(findTestObject('Sign Up/Negative/android.view.View (4)'), 0)
