...
Mobile.setText(findTestObject('Object Repository/Sign Up/android.widget.EditText (3)'), 'Pakt@1', 0)

Mobile.pressBack()

Mobile.setText(findTestObject('Object Repository/Sign Up/android.widget.EditText (4)'), 'Pakt@1', 0)
