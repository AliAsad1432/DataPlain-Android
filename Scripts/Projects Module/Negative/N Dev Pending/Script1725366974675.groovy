...
Mobile.setText(findTestObject('Object Repository/Projects Module/Positive/android.widget.EditText'), '    ', 0)
...
Mobile.verifyElementExist(findTestObject('Projects Module/Negative/android.view.View'), 0)
